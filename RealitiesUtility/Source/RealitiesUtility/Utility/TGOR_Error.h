 ...
 */
UCLASS()
class REALITIESUTILITY_API UTGOR_Error : public UObject
{
	GENERATED_BODY()
...
public:
	...
	static FString Print(const FLinearColor& V) { return(V.ToString()); }
	static FString Print(const FTransform& T) { return(T.ToString()); }
