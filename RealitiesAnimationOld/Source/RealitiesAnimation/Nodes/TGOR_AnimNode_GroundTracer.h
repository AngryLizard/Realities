...
#include "RealitiesAnimation/Structs/TGOR_Contacts.h"
...
struct REALITIESANIMATION_API FTGOR_TraceBoneReference
{
...
/** */
USTRUCT(BlueprintInternalUseOnly)
struct REALITIESANIMATION_API FTGOR_AnimNode_GroundTracer : public FAnimNode_SkeletalControlBase
{
	GENERATED_USTRUCT_BODY()
