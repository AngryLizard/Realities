 ...
 */
UCLASS()
class REALITIES_API UTGOR_Bodypart : public UTGOR_CoreContent
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "!TGOR Bodypart", Meta = (Keywords = "C++"))
		void OverrideMesh(UTGOR_ChildSkeletalMeshComponent* Component);

	/** Attach mesh component with a master mesh */
	UFUNCTION(BlueprintCallable, Category = "!TGOR Bodypart", Meta = (Keywords = "C++"))
		void AttachMesh(UTGOR_ChildSkeletalMeshComponent* Component, UTGOR_ModularSkeletalMeshComponent* MasterComponent, bool IgnoreFollowsMasterPose);

	/** Reset a mesh before removal */
	UFUNCTION(BlueprintCallable, Category = "!TGOR Bodypart", Meta = (Keywords = "C++"))
		void ResetMesh(UTGOR_ChildSkeletalMeshComponent* Component);
...
public:
	...
	/** Child bodypart insertions */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "!TGOR Insertion")
		TArray<TSubclassOf<UTGOR_Bodypart>> ChildInsertions;
