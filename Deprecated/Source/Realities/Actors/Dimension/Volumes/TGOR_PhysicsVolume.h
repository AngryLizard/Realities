...
UCLASS()
class REALITIES_API ATGOR_PhysicsVolume : public ATGOR_Actor, public ITGOR_DimensionInterface
{
	GENERATED_BODY()
...
public:
	...
	FORCEINLINE UTGOR_PilotComponent* GetOwning() const { return MobilityComponent; }
