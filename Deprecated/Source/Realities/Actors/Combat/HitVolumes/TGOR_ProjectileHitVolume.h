...
/**
 * HitVolume consisting of one or multiple projectiles, by default does standard symplectic euler with gravity and air resistance
 */
UCLASS()
class REALITIES_API ATGOR_ProjectileHitVolume : public ATGOR_HitVolume
{
	GENERATED_BODY()
