...
struct REALITIES_API FTGOR_VolumeAllocation
{
...
*/
UCLASS()
class REALITIES_API ATGOR_VolumeAllocationTest : public AActor
{
	GENERATED_BODY()
...
public:
	...
	/** Draws volumes */
	UFUNCTION(BlueprintCallable, Category = "TGOR Test", Meta = (Keywords = "C++"))
		void DrawVolumes(FLinearColor BranchColour, FLinearColor LeafColour, FLinearColor VolumeColour, float Duration, float Thicc);
