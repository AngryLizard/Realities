...
struct REALITIES_API FTGOR_PackageNetworkTestPacket
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType, Blueprintable)
struct REALITIES_API FTGOR_PackageNetworkTestInstance
{
	GENERATED_BODY()
	SERIALISE_INIT_HEADER;
...
class REALITIES_API UTGOR_PackageNetworkTestObject : public UTGOR_Object, public ITGOR_NetInterface
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class REALITIES_API ATGOR_PackageNetworkTest : public AFunctionalTest, public ITGOR_SingletonInterface
{
	GENERATED_BODY()
