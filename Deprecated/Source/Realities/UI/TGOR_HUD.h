...
#include "Realities/Base/Instances/System/TGOR_MenuInstance.h"
...
*/
UCLASS()
class REALITIES_API ATGOR_HUD : public AHUD, public ITGOR_SingletonInterface, public ITGOR_RegisterInterface
{
	GENERATED_BODY()
