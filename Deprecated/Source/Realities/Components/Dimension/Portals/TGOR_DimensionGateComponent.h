...
class REALITIES_API UTGOR_DimensionGateComponent : public UTGOR_DimensionPortalComponent
{
	GENERATED_BODY()
...
public:	
	...
	virtual void DialPortal(const FTGOR_PortalSelection& Selection) override;
