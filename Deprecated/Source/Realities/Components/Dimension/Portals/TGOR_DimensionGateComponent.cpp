...
void UTGOR_DimensionGateComponent::DialPortal(const FTGOR_PortalSelection& Selection)
{
...
void UTGOR_DimensionGateComponent::EstablishLink()
{
	...
	else
	{
		...
		UTGOR_DimensionGateComponent* Link = Cast<UTGOR_DimensionGateComponent>(GetPortalComponent());
		if (GateLink != Link)
		{
			// Link back
			GateLink = Link;
