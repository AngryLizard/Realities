...
struct CTGOR_PackageRegister
{
	uint32 Version;
	bool Cache;
};

struct CTGOR_PackageBase
{
...
struct CTGOR_RegisterList
{
	...
	uint32 GetRegisterSize(const T& Register) const; // Get size of register content in bytes
...
struct CTGOR_NetworkWritePackage : public CTGOR_PackageBase
{
...
struct CTGOR_NetworkReadPackage : public CTGOR_PackageBase
{
