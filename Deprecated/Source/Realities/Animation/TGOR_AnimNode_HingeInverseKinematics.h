...
struct REALITIES_API FTGOR_IKBoneReference
{
...
/** */
USTRUCT(BlueprintInternalUseOnly)
struct REALITIES_API FTGOR_IKEffectorReference : public FTGOR_IKBoneReference
{
	GENERATED_USTRUCT_BODY()
...
/** */
USTRUCT(BlueprintInternalUseOnly)
struct REALITIES_API FTGOR_IKHingeReference : public FTGOR_IKBoneReference
{
	GENERATED_USTRUCT_BODY()
...
/** */
USTRUCT(BlueprintInternalUseOnly)
struct REALITIES_API FTGOR_IKHinge
{
	GENERATED_USTRUCT_BODY()
...
/** */
USTRUCT(BlueprintInternalUseOnly)
struct REALITIES_API FTGOR_AnimNode_HingeInverseKinematics : public FAnimNode_SkeletalControlBase
{
	GENERATED_USTRUCT_BODY()
...
protected:
	...
	// Newtons
	bool NewtonsMethod3x3(FVector& Config, const FTransform& Tail, float Threshold, float Rate, int32 Iteration);
