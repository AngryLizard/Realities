...
struct REALITIES_API FTGOR_CommandNumericArgument
{
...
*/
USTRUCT(BlueprintType)
struct REALITIES_API FTGOR_CommandStringArgument
{
	GENERATED_USTRUCT_BODY()
...
*/
USTRUCT(BlueprintType)
struct REALITIES_API FTGOR_CommandArgument
{
	GENERATED_USTRUCT_BODY()
...
*/
USTRUCT(BlueprintType)
struct REALITIES_API FTGOR_CommandArg
{
	GENERATED_USTRUCT_BODY()
		FTGOR_CommandArg();
...
class REALITIES_API UTGOR_Command : public UTGOR_Content
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "TGOR Commands", Meta = (Keywords = "C++"))
		UTGOR_Content* FetchContent(const TMap<FString, FTGOR_CommandArg>& Args, const FString& Name);
};
