...
#include "TGOR_DoubleFloatCustomisation.generated.h"

/**
*
*/
UCLASS()
class REALITIES_API UTGOR_DoubleFloatCustomisation : public UTGOR_MeshMorphCustomisation
{
	GENERATED_BODY()

public:
	UTGOR_DoubleFloatCustomisation();
	...
	/** Positive parameter name for material */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "TGOR Customisation")
		FName PositiveParam;
};
