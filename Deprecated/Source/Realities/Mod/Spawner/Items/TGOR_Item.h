...
class REALITIES_API UTGOR_Item : public UTGOR_Spawner
{
	GENERATED_BODY()
...
protected:
	...
	/** Matter quantity per matter type this item is made out of. */
...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "TGOR Inventory")
		TMap<UTGOR_Matter*, int32> CompositionCapacity;
