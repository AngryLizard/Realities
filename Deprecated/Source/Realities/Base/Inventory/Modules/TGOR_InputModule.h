...
public:
	...
	/** Gets input state */
	UFUNCTION(BlueprintPure, Category = "TGOR System", Meta = (Keywords = "C++"))
		bool IsActive(TSubclassOf<UTGOR_Input> Input) const;

	/** Checks whether input has just overcome its threshold */
	UFUNCTION(BlueprintPure, Category = "TGOR System", Meta = (Keywords = "C++"))
		bool HasTurnedOn(TSubclassOf<UTGOR_Input> Input) const;

	/** Checks whether input has just overcome its threshold */
	UFUNCTION(BlueprintPure, Category = "TGOR System", Meta = (Keywords = "C++"))
		bool HasTurnedOff(TSubclassOf<UTGOR_Input> Input) const;
