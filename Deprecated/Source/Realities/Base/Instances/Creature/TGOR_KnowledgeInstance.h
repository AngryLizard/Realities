...
struct FTGOR_KnowledgeCollection
{
...
*/
USTRUCT(BlueprintType)
struct FTGOR_KnowledgePin : public FFastArraySerializerItem
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct FTGOR_KnowledgePinBoard : public FFastArraySerializer
{
	GENERATED_USTRUCT_BODY()
...
*/
USTRUCT(BlueprintType)
struct FTGOR_KnowledgePinRequest
{
	GENERATED_USTRUCT_BODY()
