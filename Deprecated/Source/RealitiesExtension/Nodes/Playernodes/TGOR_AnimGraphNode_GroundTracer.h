...
#include "Realities/Animation/TGOR_AnimNode_GroundTracer.h"
 ...
 */
UCLASS()
class REALITIESEXTENSION_API UTGOR_AnimGraphNode_GroundTracer : public UAnimGraphNode_SkeletalControlBase
{
