...
class REALITIES_API UTGOR_ParentModule : public UTGOR_EuclideanModule
{
	GENERATED_BODY()
...
public:
	...
	/** Compare */
	UFUNCTION(BlueprintPure, Category = "!TGOR Storage", Meta = (Keywords = "C++"))
		float Compare(UTGOR_ParentModule* Other, const FTGOR_MovementThreshold& Threshold) const;

	/** Lerp to another module */
	UFUNCTION(BlueprintCallable, Category = "!TGOR Storage", Meta = (Keywords = "C++"))
		void SetLerp(UTGOR_ParentModule* Other, float Alpha);
