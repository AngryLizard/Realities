...
void UTGOR_RagdollMovement::Tick(UTGOR_MovementComponent* Component, const FTGOR_MovementTick& Tick, const FTGOR_MovementSpace& Space, const FTGOR_MovementExternal& External, FTGOR_MovementOutput& Out)
{
	...
	// Dampen forces
	Component->GetDampingForce(Tick, Space.RelativeLinearVelocity, BrakeCoefficient * Frame.Strength, Out);
