...
#include "UISystem/UI/TGOR_QueryWidget.h"
 ...
 */
UCLASS()
class UISYSTEM_API UTGOR_ButtonArray : public UTGOR_QueryWidget
{
	GENERATED_BODY()
...
public:
	...
	virtual void ApplyQuery(UTGOR_Query* Query) override;
...
protected:
	...
	/** Return whether a given entry should be added to this list or not */
	UFUNCTION(BlueprintImplementableEvent, BlueprintPure, Category = "!TGOR Interface", Meta = (Keywords = "C++"))
		bool FilterCreateEntry(int32 Index);
