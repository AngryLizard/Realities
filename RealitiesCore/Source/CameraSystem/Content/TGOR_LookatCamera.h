 ...
 */
UCLASS()
class CAMERASYSTEM_API UTGOR_LookatCamera : public UTGOR_Camera
{
	GENERATED_BODY()
...
public:
	...
	virtual FVector4 Filter(const UTGOR_CameraComponent* Camera, const USpringArmComponent* SpringArm, const FVector& Params) const override;
