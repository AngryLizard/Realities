...
#include "CustomisationSystem/Content/Customisations/MorphTargets/TGOR_MeshMorphCustomisation.h"
 ...
 */
UCLASS()
class CUSTOMISATIONSYSTEM_API UTGOR_SingleFloatCustomisation : public UTGOR_MeshMorphCustomisation
{
	GENERATED_BODY()
