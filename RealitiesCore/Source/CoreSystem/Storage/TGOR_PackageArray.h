...
struct CORESYSTEM_API CTGOR_ArrayPackageRegister : public CTGOR_PackageRegister
{
	int32 Index;
	uint32 Size;
};
...
struct CORESYSTEM_API FTGOR_ArrayWritePackage
{
...
USTRUCT(BlueprintType)
struct CORESYSTEM_API FTGOR_ArrayReadPackage
{
	GENERATED_USTRUCT_BODY()
