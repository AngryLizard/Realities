...
#include "RealitiesUtility/Structures/TGOR_ContentTable.h"
#include "CoreSystem/Utility/TGOR_CoreEnumerations.h"

#include "../Storage/TGOR_File.h"
#include "../Storage/TGOR_SaveInterface.h"
...
class CORESYSTEM_API UTGOR_Data : public UTGOR_Object, public ITGOR_SaveInterface
{
	GENERATED_BODY()
