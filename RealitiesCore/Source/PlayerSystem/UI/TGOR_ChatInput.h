 ...
 */
UCLASS()
class PLAYERSYSTEM_API UTGOR_ChatInput : public UTGOR_Widget
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category = "!TGOR Chat", Meta = (Keywords = "C++"))
		void ChangeDomain(ETGOR_ChatDomainEnumeration Domain, const FLinearColor& Color, const FString& Subdomain);
	...
	/** Creates message color from a given message */
	UFUNCTION(BlueprintPure, Category = "!TGOR Chat", Meta = (Keywords = "C++"))
		FLinearColor CreateMessageColor(const FTGOR_ChatMessageInstance& Message);
