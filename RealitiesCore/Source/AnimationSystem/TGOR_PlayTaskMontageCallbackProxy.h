...
#include "TGOR_PlayTaskMontageCallbackProxy.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnMontagePlayDelegate, FName, NotifyName);

UCLASS(MinimalAPI)
class UTGOR_PlayTaskMontageCallbackProxy : public UObject
{
	...
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true", DefaultToSelf = "InTask"))
		static UTGOR_PlayTaskMontageCallbackProxy* CreateProxyObjectForPlayMontage(
