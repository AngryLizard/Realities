...
UCLASS()
class DIMENSIONSYSTEM_API UTGOR_ReplicationGraphNode_VolumeCell : public UReplicationGraphNode_ActorList
{
	GENERATED_BODY()
...
UCLASS()
class DIMENSIONSYSTEM_API UTGOR_ReplicationGraphNode_VolumeSpatialization : public UReplicationGraphNode, public ITGOR_SingletonInterface
{
	GENERATED_BODY()
