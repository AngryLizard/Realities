...
void UTGOR_InfluencableComponent::DirectInfluence(const FTGOR_ElementInstance& State, AActor* Instigator, int32 Identifier, int32 Segment, float Time, const FHitResult& Hit)
{
