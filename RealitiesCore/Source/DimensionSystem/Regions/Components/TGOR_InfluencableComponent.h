...
#include "DimensionSystem/Regions/TGOR_ElementInstance.h"
 ...
 */
UCLASS()
class DIMENSIONSYSTEM_API UTGOR_InfluencableComponent : public UTGOR_RegionComponent
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "!TGOR Influence", Meta = (Keywords = "C++"))
		void DirectInfluence(const FTGOR_ElementInstance& State, AActor* Instigator, int32 Identifier, int32 Segment, float Time, const FHitResult& Hit);
