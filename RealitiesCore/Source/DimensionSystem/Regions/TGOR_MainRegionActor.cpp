...
#include "DimensionSystem/Regions/TGOR_RegionActor.h"
...
void ATGOR_MainRegionActor::DebugDraw(FVector Start, FVector End, FColor Color, float Size, float Z)
{
	...
	Indices.Add(3);
	Indices.Add(2);
	DrawDebugMesh(GetWorld(), Vertices, Indices, Color, true, -1.0f, 255);

	DrawDebugLine(GetWorld(), Vertices[1], Vertices[3], Color, true, -1.0f, 255, Size);
}
