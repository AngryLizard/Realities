...
struct DIMENSIONSYSTEM_API FTGOR_StaticMeshLoaderInstance
{
...
*/
USTRUCT(BlueprintType)
struct DIMENSIONSYSTEM_API FTGOR_StaticMeshLoaderActors
{
	GENERATED_USTRUCT_BODY()
...
*/
USTRUCT(BlueprintType)
struct DIMENSIONSYSTEM_API FTGOR_StaticMeshLoaderIndices
{
	GENERATED_USTRUCT_BODY()
...
*/
UCLASS()
class DIMENSIONSYSTEM_API UTGOR_StaticMeshLoader : public UTGOR_Loader
{
	GENERATED_BODY()
