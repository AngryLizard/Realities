...
class INVENTORYSYSTEM_API UTGOR_Storage : public UTGOR_Container
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "!TGOR Storage", Meta = (DeterminesOutputType = "Type", ExpandEnumAsExecs = "Branches", Keywords = "C++"))
		UTGOR_Module* GetModuleValidated(TSubclassOf<UTGOR_Module> Type, ETGOR_FetchEnumeration& Branches);
