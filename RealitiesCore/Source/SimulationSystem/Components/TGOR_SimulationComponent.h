...
#include "DimensionSystem/Regions/Components/TGOR_InfluencableComponent.h"
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "!TGOR Creature", Meta = (Keywords = "C++"))
		bool ApplySetup(const FTGOR_SimulationInstance& Setup);
...
protected:
	...
	UPROPERTY(ReplicatedUsing = OnReplicateSetup, BlueprintReadWrite, Category = "!TGOR Creature")
		FTGOR_SimulationInstance CurrentSetup;
